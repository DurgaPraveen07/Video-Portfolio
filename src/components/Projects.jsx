...
const Projects = () => {
  ...
  return (
    <section id="projects" ref={sectionRef} className="h-screen bg-brand-black overflow-hidden relative">
      ...
      <div ref={scrollContainerRef} className="h-full flex items-center pl-[5vw] pr-[20vw] pt-20 w-max">
        {projects.map((project, index) => (
          <div key={index} className="w-[85vw] md:w-[45vw] h-[60vh] shrink-0 mr-12 md:mr-24 relative group perspective-[1000px]">
            <motion.div 
